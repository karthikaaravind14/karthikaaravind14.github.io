...
for(var x=0; x < logosCollection.length; x++) {
    var logoFolder = 'logo';
    logoSection += "<img onclick='openImage(logosCollection,logoFolder,"+x+")' src='images/"+logoFolder+"/"+logosCollection[x]+"' alt='logo-"+x+1+"'>"; 
}
...
for(var x=0; x < sketchesCollection.length; x++) {
    ...
    sketchSection += "<img onclick='openImage(sketchesCollection,sketchFolder,"+x+")' src='images/"+sketchFolder+"/"+sketchesCollection[x]+"'alt='sketch-"+x+1+"'>";
}
...
for(var x=0; x < clicksCollection.length; x++) {
    ...
    clickSection += "<img onclick='openImage(clicksCollection,clicksFolder,"+x+")' src='images/"+clicksFolder+"/"+clicksCollection[x]+"'alt='click-"+x+1+"'>";
}
...
for(var x=0; x < photoshopWorksCollection.length; x++) {
    ...
    digPaintSection += "<img onclick='openImage(photoshopWorksCollection,digFolder,"+x+")' src='images/"+digFolder+"/"+photoshopWorksCollection[x]+"'alt='digital-"+x+1+"'>";
}
...
for(var x=0; x < paintingCollection.length; x++) {
    ...
    paintingsSection += "<img onclick='openImage(paintingCollection,paintingsFolder,"+x+")' src='images/"+paintingsFolder+"/"+paintingCollection[x]+"'alt='painting-"+x+1+"'>";
}
